...
if (isset($_POST['create'])) {
    ...
    header('Location: ../views/pages/visits/index.php?success=1');
    exit;
}
...
if (isset($_POST['update'])) {
    ...
    header('Location: ../views/pages/visits/index.php?updated=1');
    exit;
}
...
if (isset($_GET['delete'])) {
    ...
    header('Location: ../views/pages/visits/index.php?deleted=1');
    exit;
}
?>
